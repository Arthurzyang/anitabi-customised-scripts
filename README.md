...
|[anitabi_to_google_maps.js](https://github.com/Arthurzyang/anitabi-customised-scripts/blob/main/multi-anime-integration.user.js)|将指定作品的地标生成为CSV/KML，用于咕噜咕噜maps|
...
## anitabi_to_google_maps.js
加两个按钮，将当前作品的地标生成为CSV/KML
